...
const bootstrap = async () => {
    ...
    const queueAdapter = env.QUEUE_BACKEND === "qstash" && env.QSTASH_TOKEN !== undefined && env.QSTASH_CALLBACK_URL !== undefined
        ? new QStashQueueAdapter({
    ...
    if (env.QUEUE_BACKEND === "qstash") {
        process.stdout.write(`${JSON.stringify({ backend: "qstash", queued: sampleJob.jobId }, null, 2)}\n`);
        return;
    }
